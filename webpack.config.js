    ...
    return {
        ...
        plugins: [
            ...
            isDevelopment &&
                new ESLintPlugin({
                    ...
                    emitWarning: false, // Do not emit warnings
                    failOnWarning: false,
                    failOnError: true, // Fail on errors
                    outputReport: true,
                }),
            new Dotenv(),
        ].filter(Boolean),
        ...
        optimization: {
            ...
            splitChunks: {
                ...
                minSize: 0, // Minimum size to trigger splitting
                cacheGroups: {
                    vendors: {
                    ...
                    common: {
                        ...
                        priority: -10, // Lower priority to prioritize vendors
                    },
                },
            },
            runtimeChunk: 'single',
